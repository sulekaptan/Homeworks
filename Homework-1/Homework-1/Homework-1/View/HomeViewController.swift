...
class HomeViewController: UIViewController {
    ...
    func setupUI(){
        ...
        mainTitleStackView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor).isActive = true
        mainTitleStackView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor).isActive = true
        //mainTitleStackView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor).isActive = true
        mainTitleStackView.widthAnchor.constraint(equalTo: contentView.widthAnchor).isActive = true
        

        contentView.addSubview(searchBar)
        searchBar.topAnchor.constraint(equalTo: mainTitleStackView.bottomAnchor).isActive = true
       ...
       // recentItemsTableView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor).isActive = true
        //recentItemsTableView.widthAnchor.constraint(equalTo: contentView.widthAnchor).isActive = true
